...
if(isset($_POST['register']))
{
	...
	include('config1.php');
	$query="insert into customer values('$name','$mobno','$email','$password')";
	$result=mysqli_query($connect,$query) or die("could not execute query");
	if($result==1)
	{
		echo '<script language="javascript">';
		echo 'alert("customer Account Is Created Successfully!")';
		echo '</script>';
	}
	else
	{
		echo '<script language="javascript">';
		echo 'alert("customer Account Is Not Created Please Check Your Details...!")';
		echo '</script>';		
	}
...
<html>
<head>
<title>Project Demo::Contact us</title>
<!--
...
<nav class="navbar">
  ...
  <a  href="contactus.php">CONTACT US</a>
    <a class="active1"  href="signup.php">SIGN UP</a>
<div class="dropdown">
